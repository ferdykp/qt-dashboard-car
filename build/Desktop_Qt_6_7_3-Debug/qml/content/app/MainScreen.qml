...
Window {
    ...
    Screen01 {
        ...
        // function switchScreen(screenFile, options) {
        //     pageLoader.source = "qrc:/content/app/ScreenMap.qml";

        //     // if (transitioning) return; // Abaikan jika sedang transisi

        //     //  transitioning = true;
        //     //  slideDirection = options?.slideDirection || "left"; // Default arah slide "left"

        //     //  // Tentukan arah animasi
        //     //  transitionAnimation.from = slideDirection === "left" ? -width : width;
        //     //  transitionAnimation.to = 0;

        //     //  // Perbarui sumber Loader dan jalankan animasi transisi
        //     //  pageLoader.source = "qrc:/content/app/ScreenMap.qml";

        //     //  transitionAnimation.start(); // Mulai animasi
        // }
        ...
        //     onStopped: {
        //         mainScreen.transitioning = false;  // Menyelesaikan transisi
        //     }
        // }
